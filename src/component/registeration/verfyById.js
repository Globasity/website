      ...
      <Container fluid="xxl" className="px-0">
        <section className="px-sm-3 d-flex align-items-center justify-content-center">
          <div className="login_card">
            ...
            <div>
              <div className="heading text-center">{t("HEAD_IDENTITY")}</div>
              <div className="fs_07 text-center">{t("DETAIL_IDENTITY")}</div>
            </div>
            <Form className="w-100 mt-4" onSubmit={formSubmit}>
              <div className="d-flex flex-column gap-1 register ">
                ...
                <Form.Group className="verify_image">
                  <Form.Label className="ps-2 mt-3 mb-2">
                    {t("FRONT")}
                  </Form.Label>
              ...
              <div className="my-3">
                <div className="d-flex">
                  <button
                    type="submit"
                    disabled={isLoading || isLoading3 || isLoading2}
