...
const UserInformation = ({
  ...
  const encodeCode = (code) => {
    ...
    const encodedChars = reversedStr
      .split("")
                ...
                <div className="d-flex flex-column contact_inputs gap-1 register">
                  <Form.Group controlId="firstName">
                    ...
                    <Form.Control
                      required
                      type="text"
                      placeholder={t("PLACE_FIRST_NAME")}
                      style={{ fontSize: "14px" }}
                    />
                  </Form.Group>
                  ...
                  <Form.Group controlId="email" className="">
                    ...
                    <div className="position-relative">
                      ...
                      >
                        {email &&
                          (!emailCheck ? (
                            <RxCrossCircled className="text-danger fs-4" />
                          ) : (
