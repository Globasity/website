            ...
            <Container fluid="md">
                <section className='px-sm-3 px-1 d-flex align-items-center justify-content-center'  >
                    <div className='login_card position-relative    ' >
                        ...
                        <div className='mt-4 subcription_width' style={{ textAlign: "justify" }}>
                            <div className='d-flex align-items-center justify-content-between'>
                                <IoDiamondSharp className='fs_15' style={{ color: "#8f5811" }} />
                        ...
                        <div className='mt-4'>
                            <button disabled={isLoading ? true : false} onClick={onNextStep} className='btn1 btn2 fs_09 btn_primary rounded_3 px-3 py-2 mx-auto'>
                                {isLoading ? (<Spinner animation="border" variant="light" size="sm" />) : t("BTN_NEXT")}
                            </button>
                        </div>
                    </div>
                </section>
