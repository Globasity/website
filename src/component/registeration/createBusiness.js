                    ...
                    <section className='px-sm-3 d-flex align-items-center justify-content-center'  >
                        <div className='login_card' >
                            ...
                            <Form className='w-100 mt-4' onSubmit={handleSubmit}>
                                <Form.Label className='ps-2 fs_11 popins_medium'>{t("BUSINESS_INFORMATION")}</Form.Label>
                                <div className='d-flex flex-column contact_inputs gap-1 register'>
                                    <Form.Group controlId='name'>
                                        <Form.Label className='ps-2 mt-4 mb-2'>{t("TITLE_B_NAME")}</Form.Label>
                                        <Form.Control required type='text' placeholder={t("PLACE_B_NAME")} className='fs_09' />
                                    </Form.Group>
                                    <Form.Group>
                                        <Form.Label className='ps-2 mb-2'>{t("Business_Images")}</Form.Label>
                                        <div className='position-relative'>
                                            <div className='identity_image position-relative mx-auto' style={{ overflow: "auto" }}>
                                                {selectedImg?.length > 0 ? (
                                                    <>{isLoading1 ? (<div className='display_flex2 h-100'>
                                                        <Spinner animation="border" variant="black" size="lg" />
                                                    </div>) :
                                                        <div className='bus_grid h-100'>
                                                            {selectedImg.map((image, index) => (
                                                                <div key={index} className="position-relative bus_img">
                                                                    <img
                                                ...
                                                <Form.Control required type='file' className='upload' accept="image/*"  // Restrict to image files
                                                    onChange={handleFileChange} placeholder='Enter Code' multiple />
                                            </div>
                                            {selectedImg?.length > 0 && (<div className='position-absolute ' style={{ top: "-10px", right: "20px", zIndex: 9999 }}  >
                                                <div className=' display_flex2'>
                                                    <Plus className='bg-black rounded-circle text-white p-1' style={{ width: "1.6rem", height: "1.6rem" }} />
                                                </div>
                                    ...
                                    <Form.Group controlId='location'>
                                        <Form.Label className='ps-2 mb-2'>{t("PLACE_LOCATION")}</Form.Label>
                                        <Form.Control required type='text' placeholder='Enter Location' className='fs_09' />
                                    </Form.Group>
                                    <Form.Group controlId='since'>
                                        <Form.Label className='ps-2 mb-2'>{t("PLACE_SINCE")}</Form.Label>
                                        <Form.Control required type='date' placeholder='Enter Since' className='fs_09' />
                                    </Form.Group>
                                    <Form.Group controlId='type'>
                                        <Form.Label className='ps-2 mb-2'>{t("TITLE_B_TYPE")}</Form.Label>
                                        <Form.Select required>
                                            <option value="">{t("PLACE_B_TYPE")}</option>
                                            {businessType?.length > 0 && businessType?.map((item) => (
                                                userLangauge === ("en") && <option key={item.id} value={userLangauge === ("en") ? item.name_eng : item.name_heb}>{userLangauge === ("en") ? item.name_eng : item.name_heb}</option>
                                            ))}

                                        </Form.Select>
                                    </Form.Group>
                                    <Form.Group controlId='status'>
                                        <Form.Label className='ps-2 mb-2'>{t("TITLE_B_STATUS")}</Form.Label>
                                        <Form.Select required>
                                            <option value="">{t("PLACE_B_STATUS")}</option>
                                            {businessStatus?.length > 0 && businessStatus?.map((item) => (
                                                userLangauge === ("en") && <option key={item.id} value={userLangauge === ("en") ? item.status_eng : item.status_heb}>{userLangauge === ("en") ? item.status_eng : item.status_heb}</option>
                                            ))}
                                        </Form.Select>
                                    </Form.Group>
                                    <Form.Group controlId='company_name'>
                                        <Form.Label className='ps-2 mb-2'>{t("CompanyName")}</Form.Label>
                                        <Form.Control required type='text' placeholder={t("CompanyName")} className='fs_09' />
                                    </Form.Group>
                                    <Form.Group controlId='company_number'>
                                        <Form.Label className='ps-2 mb-2'>{t("CompanyAddress")}</Form.Label>
                                        <Form.Control required type='text' placeholder={t("CompanyAddress")} className='fs_09' />
                                    </Form.Group>
                                    <Form.Group controlId='company_address'>
                                        <Form.Label className='ps-2 mb-2'>{t("CompanyNumber")}</Form.Label>
                                        <Form.Control required type='text' placeholder={t("CompanyNumber")} className='fs_09' />
                                    </Form.Group>
                                    <Form.Group controlId='funding_amount'>
                                        <Form.Label className='ps-2 mb-2'>{t("Funding_Amount")}</Form.Label>
                                        <Form.Control required type='number' placeholder={t("Funding_Amount")} className='fs_09' />
                                    </Form.Group>
                                    <Form.Group controlId='amount'>
                                        <Form.Label className='ps-2 mb-2'>{t("RAISED_AMOUNT")}%  ({t("optional")})</Form.Label>
                                        <div className='mb-3'>
                                            <Form.Control type='number' placeholder={t("RAISED_AMOUNT")} className='fs_09 mb-0' min={0} max={100}
                                                value={raisedAmount}
                                                onChange={handleAmountChange} />
                                            {errorMessage && <h6 className='fs_07 text-danger'>{errorMessage}</h6>}
                                        </div>
                                    ...
                                    <Form.Group controlId='description'>
                                        <Form.Label className='ps-2 mb-2'>{t("TITLE_DESC")}</Form.Label>
                                        <Form.Control required as={'textarea'} rows={3} placeholder={t("PLACE_DESC")} className='fs_09' style={{ resize: "none" }} />
                                    </Form.Group>
                                    <Form.Group controlId='obligations'>
                                        <Form.Label className='ps-2 mb-2'>{t("OBLIGATION_RES")}</Form.Label>
                                        <Form.Control required as={'textarea'} rows={3} placeholder={t("OBLIGATION_RES")} className='fs_09' style={{ resize: "none" }} />
                                    </Form.Group>
                                    <div className='heading text-center my-4'>
                                        {t("BUSINESS_DESC")}
                                    </div>
                                    <Form.Group className='mb-3'>
                                        <Form.Label className='ps-2 mb-2'>{t("Legal_Diligence")}</Form.Label>
                                        <div className='identity_image mx-auto'>
                                            {legalDiligenceImg ? (
                                                isLoading5 ? (<div className='display_flex2 h-100'>
                                                    <Spinner animation="border" variant="black" size="lg" />
                                                </div>) :
                                                    <img src={legalDiligenceImg} alt="Selected" className='display_flex2' />
                                            ) :
                                                (<div>
                                                    <div className='position-absolute top-0 w-100 bottom-0'>
                                                        <div className='display_flex2 h-100 '>
                                            ...
                                            <Form.Control required type='file' className='upload' accept="image/*"  // Restrict to image files
                                                onChange={handleFileChange6} placeholder='Enter Code' />
                                        </div>
                                    </Form.Group>
                                    <Form.Group>
                                        <Form.Label className='ps-2 mb-2'>{t("Business_Diligence")}</Form.Label>
                                        <div className='identity_image mx-auto'>
                                            {businessDiligenceImg ? (
                                                isLoading6 ? (<div className='display_flex2 h-100'>
                                                    <Spinner animation="border" variant="black" size="lg" />
                                                </div>) :
                                                    <img src={businessDiligenceImg} alt="Selected" className='display_flex2' />
                                            ) :
                                                (<div>
                                                    <div className='position-absolute top-0 w-100 bottom-0'>
                                                        <div className='display_flex2 h-100 '>
                                            ...
                                            <Form.Control required type='file' className='upload' accept="image/*"  // Restrict to image files
                                                onChange={handleFileChange7} placeholder='Enter Code' />
                                        </div>
                                    </Form.Group>
                                    ...
                                    <div className='d-flex flex-column contact_inputs gap-3 register'>
                                        <Form.Group>
                                            <Form.Label className='ps-2 mb-2'>{t("Financial_Statement")}</Form.Label>
                                            <div className='identity_image mx-auto'>
                                                {statementImg ? (
                                                    isLoading2 ? (<div className='display_flex2 h-100'>
                                                        <Spinner animation="border" variant="black" size="lg" />
                                                    </div>) :
                                                        <img src={statementImg} alt="Selected" className='display_flex2' />
                                                ) :
                                                    (<div>
                                                        <div className='position-absolute top-0 w-100 bottom-0'>
                                                            <div className='display_flex2 h-100 '>
                                                ...
                                                <Form.Control required type='file' className='upload' accept="image/*"  // Restrict to image files
                                                    onChange={handleFileChange3} placeholder='Enter Code' multiple />
                                            </div>
                                        </Form.Group>
                                        <Form.Group>
                                            <Form.Label className='ps-2 mb-2'>{t("Business_Certificate")}</Form.Label>
                                            <div className='identity_image mx-auto'>
                                                {busCertificateImg ? (
                                                    isLoading3 ? (<div className='display_flex2 h-100'>
                                                        <Spinner animation="border" variant="black" size="lg" />
                                                    </div>) :
                                                        <img src={busCertificateImg} alt="Selected" className='display_flex2' />) :
                                                    (<div>
                                                        <div className='position-absolute top-0 w-100 bottom-0'>
                                                            <div className='display_flex2 h-100 '>
                                                                <div className='id_image'>
                                                ...
                                                <Form.Control required type='file' className='upload' accept="image/*"  // Restrict to image files
                                                    onChange={handleFileChange4} placeholder='Enter Code' />
                                            </div>
                                        </Form.Group>
                                        <Form.Group>
                                            <Form.Label className='ps-2 mb-2'>{t("Other_Relevant_Document")}</Form.Label>
                                            <div className='identity_image mx-auto'>
                                                {otherDocImg ? (
                                                    isLoading4 ? (<div className='display_flex2 h-100'>
                                                        <Spinner animation="border" variant="black" size="lg" />
                                                    </div>) :
                                                        <img src={otherDocImg} alt="Selected" className='display_flex2' />) :
                                                    (<div>
                                                        <div className='position-absolute top-0 w-100 bottom-0'>
                                                            <div className='display_flex2 h-100 '>
                                                                <div className='id_image'>
                                                ...
                                                <Form.Control type='file' className='upload' accept="image/*"  // Restrict to image files
                                                    onChange={handleFileChange5} placeholder='Enter Code' />
                                            </div>
                                        </Form.Group>
                                    </div>
                                    <div className='my-4'>
