...
const ChatList = ({ name, discrip, img, activeId, setActiveChatId, setShowChat, setChatLoading, id, timestamp, notify, data, setChatDetail, setCheckMsg, setCheck }) => {
    ...
    return (
        <div>
            <div className={`_link_  border-0 `} onClick={() => toggleData(data)} style={{ cursor: "pointer", padding: "0.6rem 0.8rem" }}>
                <div className={`d-flex align-items-center chat-list-link px-2 py-2 w-100 ${isActive ? 'active' : ''}`}>
                    ...
                    <div className="d-flex justify-content-between align-items-center w-100 pe-1">
                        <div className="ps-3 mt-1">
                            <h4 className="fs_09 sk_modernist_regular my-0">
                                {name}
                            </h4>
                        ...
                        <div>
                            <h6 className="chat_detail fs_08" style={{ whiteSpace: "nowrap" }}>
                                <Moment unix fromNow>
                                    {timestamp}
                                </Moment>
                            </h6>
