                ...
                <div className="row contentCenter">
                  {investors?.length > 0 ? (
                    investors.map((items, index) => (
                      ...
                      >
                        <InvestorCard
                          investorId={items?.investor?.id}
                          name={items?.investor?.name}
                          profile={items?.url + items?.investor?.image}
                          description={items?.investor?.company_description}
