...
const ViewContract = () => {
  ...
  const handleShow = () => {
    if (
      ...
      setShow(true);
    if (
      businessData?.investor_signature === "" &&
  ...
  const checkPayement = () => {
    if (
      ...
      return toast.info(
        "You've already endorsed this contract. Kindly await the counter signature from the second party."
      );
    } else if (
      userData?.user_type === "business" &&
      (businessData?.business_signature !== "" ||
          ...
          <Container ref={targetRef}>
            <div>
              <h5 className="text-center popins_semibold fs_12">
                {t("NDA_Confidentiality_Agreement")}
              </h5>
              <p className="fs_08 text-center popins_light">
                {t("NDA_Confidentiality_Agreement_Detail")}
              </p>
            </div>

            {userLangauge === "en" && (
              <div
                className="popins_light fs_09 mt-5"
                style={{
                  lineHeight: "1.6",
                  textAlign: "justify",
                  minHeight: "20rem",
              ...
              >
                <p className="fs_09">
                  ...
                  into on the date of{" "}
                  <span className="underline popins_semibold">
                    {constractData &&
                      extractDateFromDateStr(constractData?.updated_timestamp)}
                  </span>{" "}
                  and is by and between:
                </p>
                <p>
                  <span className="popins_semibold">
                    {" "}
                ...
                <p>
                  ...
                  Agreement. Receiving Party shall not, without the prior
                  written approval of Disclosing Party, use for Receiving
                  Party's benefit, publish, copy, or otherwise disclose to
                  others, or permit the use by others for their benefit or to
                  the detriment of Disclosing Party, any Confidential
                  Information. Receiving Party shall return to Disclosing Party
                  any and all records, notes, and other written, printed, or
                ...
                <p>
                  The nondisclosure provisions of this Agreement shall survive
                  the termination of this Agreement and Receiving Party's duty
                  to hold Confidential Information in confidence shall remain in
                  effect until the Confidential Information no longer qualifies
                  as a trade secret or until Disclosing Party sends Receiving
                  Party written notice releasing Receiving Party from this
                  Agreement, whichever occurs first
                </p>
                <div className="popins_semibold mb-2"> 5. Relationships:</div>
                <p>
                  Nothing contained in this Agreement shall be deemed to
                  constitute either party a partner, joint venture or employee
                ...
                <p>
                  ...
                  prior proposals, agreements, representations, and
                ...
                <p>
                  Employee is provided notice that an individual shall not be
                  held criminally or civilly liable under any federal or state
                  trade secret law for the disclosure of a trade secret that is
                  made (i) in confidence to a federal, state, or local
                  government official, either directly or indirectly, or to an
                  attorney; and (ii) solely for the purpose of reporting or
                  investigating a suspected violation of law; or is made in a
                  complaint or other document filed in a lawsuit or other
                  proceeding, if such filing is made under seal. An individual
                  who files a lawsuit for retaliation by an employer for
                  reporting a suspected violation of law may disclose the trade
                  secret to the attorney of the individual and use the trade
                  secret information in the court proceeding, if the individual
                  (i) files any document containing the trade secret under seal;
                  and (ii) does not disclose the trade secret, except pursuant
                  to court order.
                </p>
                <div className="popins_semibold mb-2">
                  <p className=" mb-3">
                    This Agreement and each party's obligations shall be binding
                    on the representatives, assigns and successors of such
                    party. Each party has signed this Agreement through its
            ...
            {userLangauge === "he" && (
              ...
              >
                <p className="fs_09">
                  הסכם סודיות או ("הסכם") זה נכרת בתאריך{" "}
                  <span className="underline popins_semibold">
                    {" "}
                    {constractData &&
                      extractDateFromDateStr(
                        constractData?.updated_timestamp
                      )}{" "}
                  </span>{" "}
                  והוא על ידי ובין:
                </p>
                <p>
                  <span className="popins_semibold"> מידע על גילוי צד: </span>{" "}
                  <span className="underline popins_semibold">
                    {" "}
                    {senderName}{" "}
                  </span>{" "}
                ...
                <p>
                  <span className="popins_semibold"> מידע שמקבל צד: </span>{" "}
                  <span className="underline popins_semibold">
                    {receiverName}
                  </span>{" "}
                  עם כתובת למשלוח דואר של{" "}
                  <span className="underline popins_semibold">
                    {receiverEmail}
                  </span>{" "}
                  ("הצד המקבל").
                ...
                <p>
                  לצורך מניעת חשיפה בלתי מורשית של מידע סודי כהגדרתו לְהַלָן.
                  הצדדים מסכימים להיכנס ליחסי סודיות בנוגע לגילוי מידע קנייני
                  וסודי מסוים ("מידע סודי").
                </p>

                <div className="popins_semibold mb-2">
                  {" "}
                  l. הגדרה של מידע סודי:{" "}
                </div>
                <p>
                  למטרות הסכם זה, "חסוי מידע" יכלול כל מידע או חומר שיש או יכול
                  להיות בעל ערך מסחרי או שירות אחר בעסק שבו עוסק הצד החושפני. אם
                  יש מידע סודי טופס כתוב, הצד החושף יסמן או יטביע את החומרים
                  במילה "סודי" או אזהרה דומה. אם מידע סודי מועבר בעל פה, הצד
                  החושף יספק מיידית בכתב המציין שתקשורת בעל פה כזו מהווה חסוי
                  מֵידָע.
                </p>
                <div className="popins_semibold mb-2">
                  {" "}
                  2. אי הכללות ממידע סודי:{" "}
                </div>
                <p>
                  התחייבויות הצד המקבל לפי זה ההסכם אינו מתרחב למידע שהוא: (א)
                  ידוע בציבור בזמן החשיפה או לאחר מכן נודע בציבור שלא באשמת הצד
                  המקבל; (ב) גילה או נוצר על ידי הצד המקבל לפני החשיפה על ידי
                  הצד החושף; (ג) למד על ידי ה הצד המקבל באמצעים לגיטימיים שאינם
                  מהצד החושפני או החושפני נציגי המפלגה; או (ד) נחשף על ידי הצד
                  המקבל עם הצד המגלה קודם אישור בכתב.
                </p>
                <div className="popins_semibold mb-2">
                  {" "}
                  3. חובות הצד המקבל:{" "}
                ...
                <p>
                  הצד המקבל יחזיק ותשמור על הסודיות מידע בסודיות מוחלטת לטובתו
                  הבלעדית והבלעדית של הצד החושף. הצד המקבל יגביל בזהירות את
                  הגישה למידע סודי לעובדים, קבלנים וצדדים שלישיים כנדרש באופן
                  סביר וידרשו מאותם אנשים לחתום הגבלות סודיות מגנות לפחות כמו
                  אלו המופיעות בהסכם זה. הצד המקבל לא ישתמש, ללא אישור מראש
                  ובכתב של הצד החושף, לטובת הצד המקבל, לפרסם, להעתיק או לחשוף
                  לאחרים, או לאפשר שימוש על ידי אחרים לטובתם או למענם לרעת הצד
                  החושף, כל מידע סודי. הצד המקבל יחזור אל הצד החושף כל רישומים,
                  הערות וחומרים כתובים, מודפסים או מוחשיים אחרים המצויים בו
                  החזקה הנוגעת למידע סודי באופן מיידי אם הצד החושפני יבקש זאת
                  כְּתִיבָה.
                </p>
                <div className="popins_semibold mb-2"> 4. פרקי זמן.</div>
                <p>
                  הוראות סודיות החשיפה של הסכם זה יישארו לאחר סיום הסיום של הסכם
                  זה וחובתו של הצד המקבל להחזיק מידע סודי בסודיות יישאר בתוקף עד
                  שהמידע הסודי לא יתאים עוד כסוד מסחרי או עד שהצד המגלה ישלח לצד
                  המקבל הודעה בכתב המשחררת את הצד המקבל מכך הסכם, המוקדם מביניהם
                </p>
                <div className="popins_semibold mb-2"> 5. מערכות יחסים:</div>
                <p>
                  שום דבר הכלול בהסכם זה לא ייחשב ככזה צד שותף, מיזם משותף או
                  עובד של הצד השני לכל מטרה.
                </p>
                <div className="popins_semibold mb-2"> 6. הפרדה:</div>
                <p>
                  אם בית משפט ימצא תנאי כלשהו בהסכם זה בלתי חוקי או בלתי ניתן
                  לאכיפה, ה שאר הסכם זה יפורש כך שישפיע בצורה הטובה ביותר על
                  כוונת הצדדים.
                </p>
                <div className="popins_semibold mb-2"> 7. אינטגרציה:</div>
                <p>
                  הסכם זה מבטא את ההבנה המלאה של הצדדים עם כבוד לנושא ומחליף כל
                  הצעות, הסכמים, ייצוגים קודמים, והבנות. אין לתקן הסכם זה אלא
                  בכתב חתום על ידי שניהם מסיבות.
                </p>
                <div className="popins_semibold mb-2"> 8. ויתור:</div>
                <p>
                  אי מימוש זכות כלשהי המופיעה בהסכם זה לא יהווה ויתור על זכויות
                  קודמות או עוקבות.
                </p>
                <div className="popins_semibold mb-2"> 9. הודעה על חסינות:</div>
                <p>
                  לעובד ניתנת הודעה כי אדם לא יוחזק אחריות פלילית או אזרחית על
                  פי כל חוק סודות מסחריים פדרליים או ממלכתיים בגין חשיפת מסחר
                  סוד שנעשה (i) בסודיות לפקיד ממשל פדרלי, מדינתי או מקומי
                  במישרין או בעקיפין, או לעורך דין; וכן (ii) אך ורק למטרת דיווח
                  או חקירה חשד להפרת חוק; או נעשית בתלונה או במסמך אחר שהוגש
                  בתביעה או הליך אחר, אם הגשה כזו נעשית בחתימה. אדם המגיש תביעה
                  עבורו תגמול מצד מעסיק בגין דיווח על חשד להפרת חוק עשויה לחשוף
                  את המקצוע סוד לעורך הדין של הפרט ולהשתמש במידע הסודי המסחרי
                  בבית המשפט בהליך, אם היחיד (א) מגיש כל מסמך המכיל את הסוד
                  המסחרי תחת חותמת; ו-(ii) אינו חושף את הסוד המסחרי, אלא על פי
                  צו בית משפט.
                </p>
                <div className="popins_semibold mb-2">
                  <p className=" mb-3">
                    הסכם זה וההתחייבויות של כל צד יחייבו את הנציגים, המקצה
                    וממשיכיה של מפלגה כזו. כל צד חתם על הסכם זה באמצעות המורשה
                    שלו נציג.
                  </p>
                  מסיבת גילוי נאות
                </div>
                  ...
                  <div onClick={handleShow} style={{ cursor: "pointer" }}>
                    <div className="display_flex2">
                      ...
                      <img
                        src={
                          businessData?.business_signature
                            ? url + businessData?.business_signature
                            : selectedFile
                            ? selectedFile
                            : whiteImage
                        }
                ...
                >
                  <div className="display_flex2">
                    ...
                    <img
                      src={
                        businessData?.investor_signature
                          ? url + businessData?.investor_signature
                          : selectedFile
                          ? selectedFile
                          : whiteImage
                      }
            ...
            <div className="display_flex2 gap-3 my-5">
              ...
              businessData?.investor_signature !== "" ? (
                <button
                  ...
                  onClick={() =>
                    handleChat(
                      businessData?.business_user,
                      businessData?.investor_user
                    )
                  }
