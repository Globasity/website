...
const ViewContract = () => {
    ...
    const handleShow = () => {
        if (businessData?.business_signature === "" && userData?.user_type === "business") setShow(true)
        if (businessData?.investor_signature === "" && userData?.user_type === "investor") setShow(true)
    }
    ...
    const checkPayement = () => {
        if (userData?.user_type === "investor" && (businessData?.business_signature === "" || businessData?.investor_signature !== "")) {
            return toast.info("You've already endorsed this contract. Kindly await the counter signature from the second party.")
        } else
            if (userData?.user_type === "business" && (businessData?.business_signature !== "" || businessData?.investor_signature === "")) {
                return toast.info("You've already endorsed this contract. Kindly await the counter signature from the second party.")
            }
        if (imageName) {
                ...
                <section className='mt-4 nda_con'>
                        ...
                        <div className='d-flex gap-4 justify-content-between' style={{ alignItems: "stretch" }} >
                            {userData?.user_type === "business" ?
                                (<div className=''>
                                    <div onClick={handleShow} style={{ cursor: "pointer" }}>
                                        <div className='display_flex2'>  <img src={businessData?.business_signature ? url + businessData?.business_signature : (selectedFile ? selectedFile : whiteImage)} alt='' className=' signature_img' /></div>
                                ...
                                (<div className=''>
                                    <div>
                                        <div className='display_flex2'>  <img src={businessData?.business_signature ? url + businessData?.business_signature : whiteImage} alt='' className=' signature_img' /></div>
                            ...
                            {userData?.user_type === "investor" ?
                                (<div className='' onClick={handleShow} style={{ cursor: "pointer" }}>
                                    <div className='display_flex2'>  <img src={businessData?.investor_signature ? url + businessData?.investor_signature : (selectedFile ? selectedFile : whiteImage)} alt='' className=' signature_img' /></div>
                                    <hr className='mx-2 my-1' style={{ opacity: "1" }}></hr>
                                    <h6 className='popins_semibold text-center fs_08 pt-1'>{t("Investor_Signatures")}</h6>
                                </div>) :
                                (<div className=''>
                                    <div className='display_flex2'>  <img src={businessData?.investor_signature ? url + businessData?.investor_signature : whiteImage} alt='' className=' signature_img' /></div>
                                    <hr className='mx-2 my-1' style={{ opacity: "1" }}></hr>
                                    <h6 className='popins_semibold text-center fs_08 pt-1'>{t("Investor_Signatures")}</h6>
                                </div>)}
                        </div>
                    ...
                    <Container>
                        <div className='display_flex2 gap-3 my-5'>
                            {(businessData?.business_signature !== "" && businessData?.investor_signature !== "") ? (
                                <button type='button' onClick={() => handleChat(businessData?.business_user, businessData?.investor_user)} className='btn1 btn2 btn2 fs_09 btn_primary rounded_3 px-4 py-2'>
                                    {
                                        isLoading ?
