...
const ViewInitialContract = () => {
  ...
  const creatContract = () => {
    if (imageName) {
      ...
      body.append(
        "investor_signature",
        userData?.user_type === "investor" ? formData.investor_signature : ""
      );
      body.append(
        "business_signature",
        userData?.user_type === "business" ? formData.business_signature : ""
      );
              ...
              {userData?.user_type === "business" ? (
                <div className="">
                  <div onClick={handleShow} style={{ cursor: "pointer" }}>
                    <div className="display_flex2">
                      {" "}
                      <img
                        src={selectedFile ? selectedFile : whiteImage}
                        alt=""
                ...
                <div className="">
                  <div>
                    <div className="display_flex2">
                      {" "}
                      <img src={whiteImage} alt="" className=" signature_img" />
                    </div>
