...
const FavBusiness = () => {
  ...
  const filteredBusinessData = allBusinessType2?.filter((business) => {
    ...
    if (
      businessStatus &&
      businessStatus !== "" &&
      business?.business?.business_status !== businessStatus
    ) {
      return false;
    }
    if (
      businessType &&
      businessType !== "" &&
      business?.business?.business_type !== businessType
    ) {
      return false;
    }
    return true;
            ...
            <Container fluid="lg">
              ...
              <div className="mb-5 mt-5">
                ...
                <div className="fs_08 popins_light text-center mt-1">
                  You can see favorite startups here
                </div>
              </div>
              <div>
          ...
          {allBusinessType?.length > 0 &&
            ...
            allBusinessType?.length >= 10 && (
              <button
                ...
                onClick={() => getFavBusinessOnScroll(lastId)}
              >
