      ...
      apiRequest({ body })
        .then((result) => {
          if (result?.length > 0 || result?.data?.length > 0) {
            ...
            toast.info(
              `You cannot create the business contract because it was originally generated by ${businessData?.business_user?.name}`
            );
          }
          setIsLoading(false);
        })
                        ...
                        <>
                          ...
                          <div className="mt-2 display_flex2 gap-3 flex-wrap">
                            ...
                            <button
                              ...
                              className=" btn1 btn_minWidth fs_07 btn_primary_outline fs_09 rounded-3 px-3 py-2"
                            >
                              <Download
                                className=""
                                style={{ height: "1rem" }}
