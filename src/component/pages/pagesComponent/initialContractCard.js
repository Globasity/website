          ...
          <div className="display_flex justify-content-between">
            <div className="display_flex">
              ...
              <div className="ms-3" style={{ lineHeight: 1 }}>
                ...
                <span className="fs_06" style={{ opacity: "0.7" }}>
                  Business Name:{" "}
                </span>{" "}
                <span className="popins_semibold fs_08 ">{businessName}</span>
              </div>
            </div>
          </div>
          <hr className=" mx-4" style={{ opacity: "0.12" }}></hr>
          <div className="popins_light fs_08 text_detail2">{description}</div>
        </div>
        <div>
          {completed === false && (
            <div className="mt-4 display_flex2 gap-3 flex-wrap">
              <button
                onClick={() => handleViewAdd("/view-contract", businessData)}
                className=" btn1 btn_minWidth fs_07 btn_primary rounded-3 px-3 py-2"
              >
                {t("VIEW_CONTRACT")}
              </button>
              <button
                onClick={() =>
                  handleViewAdd("/business-detail", businessData?.business)
                }
                className=" btn1 btn_minWidth fs_07 btn_primary_outline rounded-3 px-3 py-2"
              >
                {t("VIEW_BUSINESS")}
              </button>
            </div>
              ...
              {businessData?.is_business_exist ? (
                <div className="mt-2">
                  {userData.user_type === "investor" &&
                    (businessData?.is_business_exist?.investor_signature ? (
                      <>
                  ...
                  {userData.user_type === "business" &&
                    (businessData?.is_business_exist?.business_signature ? (
                      <>
                        <div className="text-danger popins_semibold text-center fs_09">
                          {t("ALREADY_CREATED")}
                        </div>
                      ...
                      <div className="mt-3 display_flex2 gap-3 flex-wrap">
                        <button
                          disabled={isLoading ? true : false}
                          onClick={() => handleShow(businessData)}
                          className=" btn1 btn_minWidth fs_07 btn_primary rounded-3 px-3 py-2"
                        >
                          {isLoading ? (
                            <Spinner animation="border" size="sm" />
...
export default InitialContractCard;
