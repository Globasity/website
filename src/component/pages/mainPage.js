                ...
                <Container fluid="xxl" className="px-0 position-relative">
                    ...
                    <section>
                        <div className="py-5 mb-5 px-sm-5 px-3">
                            <div className="grid2">
                                <div className="text_width w-100">
                                    {t("Paragraph1")}
                                </div>
                                ...
                                <div className=" display_flex2 mt-lg-0 mt-5 gap-3 flex-wrap">
                                    ...
                                    <div className="rec1">
                                        <div className="text-center" style={{ color: "#9CD161" }}>
                                            ...
                                            <h6 className="popins_semibold">{t("Investment_Ideas")}</h6>
                                        </div>
                                    </div>
                                    <div className="rec3">
                    ...
                    <div className="business_interest px-md-5 px-sm-5 px-3">
                        <div className="row pb-5">
                            <div className="col-lg-6 business_interest_col_1 ">
                                ...
                                <div className="jobs_internship my-3 d-flex flex-column gap-3">
                                    <p className="m-0 p-0">
                                        {t("Para3_Point1")}
                                    </p>
                                    <span>
                            ...
                            <div className="col-lg-6">
                                <div className="px-sm-5 px-2 py-4 portfolio_image h-100 w-100">
                                    <img
                                        src={invest_img6}
                                        style={{ width: "24rem", borderRadius: "22px", objectFit: "cover" }}
                                        className="PI h-100" alt=""
                                    />
                    ...
                    <section className="px-md-5 px-3 text-center mb-3">
                        <div className="banner_main py-5 ">
                            ...
                            <div className=" d-flex gap-3 justify-content-center flex-row flex-wrap px-3">
                                <MainPageCards amount="$49.00" img={businessman} name={t("Business_Man_Subcription")} />
                    ...
                    <section className="px-md-5 px-sm-5 px-3">
                        <div className="row align-items-center justify-content-center">
                            <div className="col-xl-6 col-lg-5 py-5">
                                <img src={graph1} className="client_img" style={{}} alt="" />
                            </div>
                    ...
                    <section id="craft" className="px-md-5 px-4 ">
                        <div className="d-flex align-items-center justify-content-center craft">
                            <span>
                                {t("Revolutionizing_Financing")}
                            </span>
                        </div>
                        <div className="row py-5 align-items-center justify-content-between px-2" >
                            <div className="col-lg-8 ">
                                <img src={invest_img8} alt="" style={{ width: "100%", maxHeight: "28rem", objectFit: "cover", borderRadius: "20px" }} />
                            </div>
